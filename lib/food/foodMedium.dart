...
class foodMedium extends StatefulWidget {
  foodMedium({Key key}) : super(key: key);

  @override
  _WordFindState createState() => _WordFindState();
}

class _WordFindState extends State<foodMedium> {
  ...
  void initState() {
    ...
    listQuestions = [
      WordFindQues(
        question: "What is name of this food?",
        answer: "mochi",
        pathImage:
            "https://img-global.cpcdn.com/recipes/a0c056cdc8431982/751x532cq70/mochi-isi-coklat-foto-resep-utama.jpg",
      ),
      WordFindQues(
        question: "What is name of this food?",
        answer: "bacang",
        pathImage:
            "https://asset.kompas.com/crops/mA3rGuXtNi87yiddju6-fhgM4dE=/0x41:1000x708/750x500/data/photo/2021/06/14/60c6fa40cc598.jpg",
      ),
      WordFindQues(
        question: "What is name of this food?",
        answer: "taiyaki",
        pathImage:
            "https://upload.wikimedia.org/wikipedia/commons/8/8e/Taiyaki_003.jpg",
      ),
      WordFindQues(
        question: "What is name of this food?",
        answer: "tempura",
        pathImage:
            "https://d1bpj0tv6vfxyp.cloudfront.net/articles/754034f1-32fe-4979-a035-4a86244e1180_article_image_url.webp",
      ),
    ];
  }
