...
class foodHard extends StatefulWidget {
  foodHard({Key key}) : super(key: key);

  @override
  _WordFindState createState() => _WordFindState();
}

class _WordFindState extends State<foodHard> {
  ...
  void initState() {
    ...
    listQuestions = [
      WordFindQues(
        ...
        answer: "souffle",
        pathImage:
            "https://ichef.bbci.co.uk/food/ic/food_16x9_1600/recipes/mary_berrys_lovely_lemon_73914_16x9.jpg",
      ),
      WordFindQues(
        question: "What is name of this food?",
        answer: "risotto",
        pathImage:
            "https://bakeitwithlove.com/wp-content/uploads/2021/05/Lobster-Risotto-sq.png",
      ),
      WordFindQues(
        question: "What is name of this food?",
        answer: "terrine",
        pathImage:
            "https://sicaelisabeth.files.wordpress.com/2016/10/4372-1_0.jpg",
      ),
      WordFindQues(
        question: "What is name of this food?",
        answer: "somen",
        pathImage:
            "https://cdns.klimg.com/merdeka.com/i/w/foto/2014/09/01/195045/real/somen-001-tantri-setyorini.jpg?20140901030150",
      ),
    ];
  }
