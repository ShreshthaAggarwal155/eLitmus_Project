...
class foodEasy extends StatefulWidget {
  foodEasy({Key key}) : super(key: key);

  @override
  _WordFindState createState() => _WordFindState();
}

class _WordFindState extends State<foodEasy> {
  ...
  void initState() {
    ...
    listQuestions = [
      WordFindQues(
        ...
        answer: "burger",
        pathImage: "https://picfiles.alphacoders.com/309/309254.jpg",
      ),
      WordFindQues(
        question: "What is name of this food?",
        answer: "pizza",
        pathImage: "https://picfiles.alphacoders.com/275/275506.jpg",
      ),
      WordFindQues(
        question: "What is name of this food?",
        answer: "steak",
        pathImage: "https://picfiles.alphacoders.com/158/1583.jpg",
      ),
      WordFindQues(
        question: "What is name of this food?",
        answer: "hotdog",
