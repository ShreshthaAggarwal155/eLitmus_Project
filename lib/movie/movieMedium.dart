...
class movieMedium extends StatefulWidget {
  movieMedium({Key key}) : super(key: key);

  @override
  _WordFindState createState() => _WordFindState();
}

class _WordFindState extends State<movieMedium> {
  ...
  void initState() {
    ...
    listQuestions = [
      WordFindQues(
        ...
        answer: "bond",
        pathImage: "https://images6.alphacoders.com/659/659430.jpg",
      ),
      WordFindQues(
        question: "What is name of this movie?",
        answer: "Jaws",
        pathImage: "https://images6.alphacoders.com/795/795857.jpg",
      ),
      WordFindQues(
        question: "What is name of this movie?",
        answer: "ET",
        pathImage: "https://images5.alphacoders.com/466/466322.jpg",
      ),
      WordFindQues(
        question: "What is name of this movie?",
        answer: "Us",
        pathImage: "https://images3.alphacoders.com/100/1001405.jpg",
      ),
    ];
  }
