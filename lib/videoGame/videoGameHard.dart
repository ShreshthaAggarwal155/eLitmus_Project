...
class videoGameHard extends StatefulWidget {
  videoGameHard({Key key}) : super(key: key);

  @override
  _WordFindState createState() => _WordFindState();
}

class _WordFindState extends State<videoGameHard> {
  ...
  void initState() {
    ...
    listQuestions = [
      WordFindQues(
        ...
        answer: "megaman",
        pathImage: "https://picfiles.alphacoders.com/459/459561.jpg",
      ),
      WordFindQues(
        question: "What is the name of this game?",
        answer: "disgaea",
        pathImage: "https://picfiles.alphacoders.com/219/21951.jpg",
      ),
      WordFindQues(
        question: "What is the name of this game?",
        answer: "patapon",
        pathImage:
            "https://jagatplay.com/wp-content/webp-express/webp-images/doc-root/wp-content/uploads/2017/08/Patapon-Remastered-jagatplay-13-600x338.jpg.webp",
      ),
      WordFindQues(
        question: "What is the name of this game?",
        answer: "okami",
        pathImage: "https://picfiles.alphacoders.com/320/320781.jpg",
      ),
    ];
  }
