...
class videoGameEasy extends StatefulWidget {
  videoGameEasy({Key key}) : super(key: key);

  @override
  _WordFindState createState() => _WordFindState();
}

class _WordFindState extends State<videoGameEasy> {
  ...
  void initState() {
    ...
    listQuestions = [
      WordFindQues(
        ...
        answer: "digimon",
        pathImage:
            "https://www.greenscene.co.id/wp-content/uploads/2020/12/Digimon-696x497.jpg",
      ),
      WordFindQues(
        question: "What is the name of this game?",
        answer: "amongus",
        pathImage: "https://picfiles.alphacoders.com/413/413772.png",
      ),
      WordFindQues(
        question: "What is the name of this game?",
        answer: "dota",
        pathImage: "https://picfiles.alphacoders.com/263/263846.jpg",
      ),
      WordFindQues(
        question: "What is the name of this game?",
        answer: "pokemon",
        pathImage: "https://picfiles.alphacoders.com/232/232619.jpg",
      ),
    ];
  }
