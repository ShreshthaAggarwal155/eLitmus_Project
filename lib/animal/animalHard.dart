...
class animalHard extends StatefulWidget {
  animalHard({Key key}) : super(key: key);

  @override
  _WordFindState createState() => _WordFindState();
}

class _WordFindState extends State<animalHard> {
  ...
  void initState() {
    ...
    listQuestions = [
      WordFindQues(
        ...
        answer: "axolotl",
        pathImage: "https://picfiles.alphacoders.com/235/235053.jpg",
      ),
      WordFindQues(
        question: "What is the name of this animal?",
        answer: "gecko",
        pathImage:
            "https://www.hewan-peliharaan.com/wp-content/uploads/2020/09/leopard-gecko-header.jpg",
      ),
      WordFindQues(
        question: "What is the name of this animal?",
        answer: "dugong",
        pathImage: "https://picfiles.alphacoders.com/282/282019.jpg",
      ),
      WordFindQues(
        question: "What is the name of this animal?",
        answer: "lemur",
        pathImage: "https://picfiles.alphacoders.com/321/321907.jpg",
      ),
    ];
  }
