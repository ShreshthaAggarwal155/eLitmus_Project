...
class animalMedium extends StatefulWidget {
  animalMedium({Key key}) : super(key: key);

  @override
  _WordFindState createState() => _WordFindState();
}

class _WordFindState extends State<animalMedium> {
  ...
  void initState() {
    ...
    listQuestions = [
      WordFindQues(
        ...
        answer: "otter",
        pathImage: "https://picfiles.alphacoders.com/295/295390.jpg",
      ),
      WordFindQues(
        question: "What is the name of this animal?",
        answer: "sloth",
        pathImage: "https://picfiles.alphacoders.com/303/303508.jpg",
      ),
      WordFindQues(
        question: "What is the name of this animal?",
        answer: "leopard",
        pathImage:
            "https://cdn.pixabay.com/photo/2019/04/08/13/24/amur-leopard-4112011_960_720.jpg",
      ),
      WordFindQues(
        question: "What is the name of this animal?",
        answer: "tapir",
        pathImage:
            "https://www.listchallenges.com/f/items/72f7af46-c64b-4dbc-b0f6-9c69f5187eaf.jpg",
      ),
    ];
  }
